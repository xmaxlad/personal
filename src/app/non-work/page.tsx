...
const articles = [
    {
        ...
        it was filled with rabindranath tagore paintings, i did not know he was a painter too! and apparently all of his paintings had a vibe that i could not believe is 
        mainstream, something that i'd fw. 
        `
    },
    {
        ...
        he has been sent by the god himself and he talks to god on a daily basis and on the other hand for gen-z it's some pop star, lana, taylor, or even frankocean to name a few.
...
export default function Page(){
    return(
        <div className="font-mono m-6 flex flex-col space-y-6">
            ...
            <div className=' flex flex-col space-y-6 md:flex md:flex-row md:space-x-14'> 
            ...
            <div className="md:w-1/2"> 
             <div className="text-xl py-2">excerpts</div> 
